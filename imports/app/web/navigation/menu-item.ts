...
export class MenuItem {
  ...
  constructor(private titleOrData: string | {title: string, link?: string, icon?: string, children?: MenuItem[], queryParams?: Object, clickHandler?: (event: MouseEvent, navigation: NavigationService, sidenavItem: SidenavItemComponent) => boolean, pathMatch?: string}, public link: string = null, public children: MenuItem[] = [], public queryParams: Object = {}, public clickHandler: (event: MouseEvent, navigation: NavigationService, sidenavItem: SidenavItemComponent) => boolean = null, icon: string = null, public pathMatch: string = 'full') {
